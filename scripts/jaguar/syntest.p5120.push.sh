...
do
	...
	do
		date
		echo aprun -S 8 -n 5120 ${BINDIR}/bin/SynData_Push.exe -i ${DATADIR} -o ${OUTDIR}/synthetic.datasizes.p5120.push -n 25600 -t ${transport} -b 4 -P 600 -p 15 -m ${size} -c 0 -l 1 
		aprun -S 8 -n 5120 ${BINDIR}/bin/SynData_Push.exe -i ${DATADIR} -o ${OUTDIR}/synthetic.datasizes.p5120.push -n 25600 -t ${transport} -b 4 -P 600 -p 15 -m ${size} -c 0 -l 1 
