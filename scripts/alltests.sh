...
do
	...
	mpirun -np 8 ${bindir}/bin/SegmentNuclei.exe -g ${outroot}-sep-${transport}-uncompressed-NB -i ${indir} -o ${outroot}-sep-${transport}-uncompressed-NB -n ${filecount} -t ${transport} -b ${buffersize} -P ${iosize} -p ${subgroup} -c 0 -l 1 -S 0                                                                      done
...
transport="POSIX"
	...
	echo mpirun -np 8 ${bindir}/bin/SegmentNuclei.exe -g ${outroot}-synsep-${transport}-compressed-NB   -i ${indir} -o ${outroot}-synsep-${transport}-compressed-NB   -n ${filecount} -t ${transport} -b ${buffersize} -P ${iosize} -p ${subgroup} -c 0 -l 1 -S 1 -d ${synComputeParams} -m ${datasize}
	mpirun -np 8 ${bindir}/bin/SegmentNuclei.exe -g ${outroot}-synsep-${transport}-compressed-NB   -i ${indir} -o ${outroot}-synsep-${transport}-compressed-NB   -n ${filecount} -t ${transport} -b ${buffersize} -P ${iosize} -p ${subgroup} -c 0 -l 1 -S 1 -d ${synComputeParams} -m ${datasize}
	...
	echo mpirun -np 8 ${bindir}/bin/SegmentNucleiReader.exe -g ${outroot}-sepR-${transport}-compressed      -i ${indir} -o ${outroot}-sepR-${transport}-compressed      -n ${filecount} -t ${transport} -b ${buffersize} -Q ${readsize} -P ${iosize} -p ${subgroup} -c 0 -l 1 -S 0
	mpirun -np 8 ${bindir}/bin/SegmentNucleiReader.exe -g ${outroot}-sepR-${transport}-compressed      -i ${indir} -o ${outroot}-sepR-${transport}-compressed      -n ${filecount} -t ${transport} -b ${buffersize} -Q ${readsize} -P ${iosize} -p ${subgroup} -c 0 -l 1 -S 0
