...
do
	...
	do
		date
		echo "mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/SynData_Full.exe ${DATADIR} ${OUTDIR}/synthetic.datasizes.p720 18000 cpu ${transport} 4 60 1 15 1 0 ${size}"
		mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/SynData_Full.exe ${DATADIR} ${OUTDIR}/synthetic.datasizes.p720 18000 cpu ${transport} 4 60 1 15 1 0 ${size} 
		
		rm -rf ${OUTDIR}/synthetic.datasizes.p720
        mv ${OUTDIR}/synthetic.datasizes.p720.csv ${OUTDIR}/synthetic.datasizes.p720.${transport}.${size}.csv
