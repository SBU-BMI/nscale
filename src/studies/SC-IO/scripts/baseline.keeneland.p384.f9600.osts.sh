#!/bin/sh
#PBS -N TCGA.baseline.keeneland.p384.f9600.osts
#PBS -j oe
#PBS -A UT-NTNL0111
#PBS -m abe
...
mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/nu-segment-scio.exe ${DATADIR} ${OUTDIR} 9600 0-200 cpu
date

mv ${OUTDIR}.csv ${OUTDIR}/../TCGA.baseline.keeneland.p384.f9600.osts.csv
exit 0
# eof
