#!/bin/sh
#PBS -N TCGA.baseline.keeneland.p96.f2400
#PBS -j oe
#PBS -A UT-NTNL0111
#PBS -m abe
...
mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/nu-segment-scio.exe ${DATADIR} ${OUTDIR}/TCGA.baseline.keeneland.p96.f2400 2400 0-200 cpu
date

rm -rf ${OUTDIR}/TCGA.baseline.keeneland.p96.f2400
rm ${OUTDIR}/TCGA.baseline.keeneland.p96.f2400.*.bp
