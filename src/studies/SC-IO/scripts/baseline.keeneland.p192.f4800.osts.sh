#!/bin/sh
#PBS -N TCGA.baseline.keeneland.p192.f4800.osts
#PBS -j oe
#PBS -A UT-NTNL0111
#PBS -m abe
...
mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/nu-segment-scio.exe ${DATADIR} ${OUTDIR} 4800 0-200 cpu
date

mv ${OUTDIR}.csv ${OUTDIR}/../TCGA.baseline.keeneland.p192.f4800.osts.csv
exit 0
# eof
