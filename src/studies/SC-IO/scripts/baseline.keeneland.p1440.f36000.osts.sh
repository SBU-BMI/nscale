#!/bin/sh
#PBS -N TCGA.baseline.keeneland.p1440.f36000.osts
#PBS -j oe
#PBS -A UT-NTNL0111
#PBS -m abe
...
mpirun --mca mpi_paffinity_alone 1 ${BINDIR}/bin/nu-segment-scio.exe ${DATADIR} ${OUTDIR} 36000 0-200 cpu
date

mv ${OUTDIR}.csv ${OUTDIR}/../TCGA.baseline.keeneland.p1440.f36000.osts.csv
