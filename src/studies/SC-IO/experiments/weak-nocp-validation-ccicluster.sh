...
do
	...
	mpirun -np $i --hostfile ${HOSTFILE} --bynode ${BIN_DIR}/nu-segment-scio.exe ${IN_DATA_DIR}/ValidationSet ${OUT_DATA_DIR}/scio-val-mpi ${TOTAL_COUNT} 100 cpu 1 > ${OUT_DIR}/${OUT_PREFIX}.${i}.csv
done
