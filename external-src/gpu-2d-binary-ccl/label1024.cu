...
__device__ __inline__ void detectRuns1024(ushort* pt, uchar* ct, uchar* ps, uchar* px, ushort* tbf, uint cp2)
{
	uint* ps4 = (uint*)ps;
	uint* pt2 = (uint*)pt;
...
__global__ void pass1_1024(ushort* pt, uchar* ps, ushort* b,  ushort* b2, uint h, ushort* eb)
{
...
__global__ void pass2_1024(ushort* ib, uint* glabel, uint h, uint pitch)
{
...
__global__ void pass3_1024(ushort* pt, ushort* ps, ushort* b, uint* label, uint h)
{
...
void label_1024(CudaBuffer* cbpt, CudaBuffer* cbpt2, CudaBuffer* cbps, CudaBuffer* cbb, CudaBuffer* cbb2, CudaBuffer* cbglabel, uint h, uint bn, CudaBuffer* cbeb)
{
