 ...
 * svsNuclei_emxutil.c
 *
 * Code generation for function 'svsNuclei_emxutil'
 *
...
void emxInit_char_T(emxArray_char_T **pEmxArray, int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
    ...
    *pEmxArray = (emxArray_char_T *)malloc(sizeof(emxArray_char_T));
    ...
    if (doPush) {
        emlrtPushHeapReferenceStack((void *)pEmxArray, (void (*)(void *, boolean_T))emxFree_char_T);
    }
    emxArray = *pEmxArray;
...
/* End of code generation (svsNuclei_emxutil.c) */
